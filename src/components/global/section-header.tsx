...
const SectionHeader = ({ section, className, id }: SectionHeaderProps) => {
  const t = useTranslations(`content-0${section}`)
  return (
    <div className={cn('space-y-4', className)} aria-labelledby={id}>
      <h1 id={id} className='text-black text-xl md:text-3xl font-bold'>
